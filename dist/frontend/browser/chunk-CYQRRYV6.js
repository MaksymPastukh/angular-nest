...
// apps/marketplace-web/src/app/features/auth/pages/register-page/register-page.ts
...
var RegisterPage = class _RegisterPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterPage, selectors: [["app-register"]], decls: 76, vars: 35, consts: () => {
    let i18n_0;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$APPS_MARKETPLACE_WEB_SRC_APP_FEATURES_AUTH_PAGES_REGISTER_PAGE_REGISTER_PAGE_TS_0 = goog.getMsg("image login");
      i18n_0 = MSG_EXTERNAL_imageLogin$$APPS_MARKETPLACE_WEB_SRC_APP_FEATURES_AUTH_PAGES_REGISTER_PAGE_REGISTER_PAGE_TS_0;
    } else {
...
`, styles: ['@charset "UTF-8";\n\n/* apps/marketplace-web/src/app/features/auth/pages/register-page/register-page.scss */\n.auth-checkbox input {\n  appearance: none;\n  -webkit-appearance: none;\n  border: 0.1rem solid #3c4242;\n  border-radius: 3px;\n  width: 18px;\n  height: 18px;\n  padding: 0;\n  margin: 0.2rem 0 0 0;\n  cursor: pointer;\n  position: relative;\n  outline: none;\n}\n.auth-checkbox input:checked {\n  background-color: #3c4242;\n  border: 0.1rem solid #3c4242;\n}\n.auth-checkbox input:checked::after {\n  content: "\\2713";\n  position: absolute;\n  color: white;\n  padding: 0;\n  font-size: 18px;\n  font-weight: 700;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n}\n/*# sourceMappingURL=register-page.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RegisterPage, { className: "RegisterPage", filePath: "apps/marketplace-web/src/app/features/auth/pages/register-page/register-page.ts", lineNumber: 27 });
})();
export {
  RegisterPage
};
//# sourceMappingURL=chunk-CYQRRYV6.js.map
