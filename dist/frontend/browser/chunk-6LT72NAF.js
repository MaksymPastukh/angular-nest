...
// libs/frontend/admin/ui/src/lib/admin-nav/admin-nav.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminNav, { className: "AdminNav", filePath: "libs/frontend/admin/ui/src/lib/admin-nav/admin-nav.ts", lineNumber: 11 });
})();

// libs/frontend/admin/ui/src/lib/admin-layout/admin-layout.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminLayout, { className: "AdminLayout", filePath: "libs/frontend/admin/ui/src/lib/admin-layout/admin-layout.ts", lineNumber: 15 });
})();

// libs/frontend/admin/feature-dashboard/src/lib/admin.routes.ts
var ADMIN_ROUTES = [
  {
    path: "panel",
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-SJMYMP3X.js").then((c) => c.CreateProductPage),
        data: { breadcrumb: "Create product" }
      },
      {
        path: "questions",
        loadComponent: () => import("./chunk-CED2MJ43.js").then((c) => c.AdminQuestionsPageComponent),
...
//# sourceMappingURL=chunk-6LT72NAF.js.map
