...
// apps/marketplace-web/src/app/features/admin/pages/admin-products/pages/create-product-page/create-product-page.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateProductPage, { className: "CreateProductPage", filePath: "apps/marketplace-web/src/app/features/admin/pages/admin-products/pages/create-product-page/create-product-page.ts", lineNumber: 41 });
})();
export {
  CreateProductPage
};
...
@angular/forms/fesm2022/signals-compat.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-TWNKSHI3.js.map
