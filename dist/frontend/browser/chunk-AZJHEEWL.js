...
// apps/marketplace-web/src/app/features/wishlist/ui/wishlist-item-ui/wishlist-item.ts
var WishlistItem = class _WishlistItem {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WishlistItem, selectors: [["app-wishlist-item"]], inputs: { item: [1, "item"] }, decls: 18, vars: 12, consts: [[1, "flex", "w-full", "items-center", "gap-10", "border-b", "border-slate-200", "py-6"], ["type", "button", "aria-label", "Remove", 1, "shrink-0", "rounded-full", "p-2", "cursor-pointer", "text-slate-500", "hover:bg-slate-100", "hover:text-slate-700", "active:scale-95", "transition", 3, "click"], ["width", "28", "height", "28", "viewBox", "0 0 22 22", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["d", "M18 4L4 18M18 18L4 4.00001", "stroke", "#3C4242", "stroke-width", "1.5", "stroke-linecap", "round"], [1, "h-28", "w-28", "shrink-0", "overflow-hidden", "rounded-xl", "bg-slate-100"], [1, "w-full", "max-w-xl", "aspect-4/5", "overflow-hidden"], [1, "h-full", "w-full", "object-cover", 3, "error", "src", "alt"], [1, "min-w-0", "flex-1"], [1, "truncate", "text-2xl", "font-family", "font-bold", "color-text-base", "cursor-pointer", 3, "click"], [1, "mt-2", "text-2xl", "font-family", "font-bold", "text-gray-500", "md:hidden"], [1, "hidden", "shrink-0", "text-xl", "font-family", "font-bold", "text-gray-500", "md:block"], ["type", "button", 1, "shrink-0", "rounded-lg", "bg-violet-600", "cursor-pointer", "px-6", "py-2.5", "text-lg", "font-semibold", "font-family", "text-white", "hover:bg-violet-700", "active:scale-95", "transition"]], template: function WishlistItem_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(8, "div", 7)(9, "div", 8);
      \u0275\u0275domListener("click", function WishlistItem_Template_div_click_9_listener() {
...
(() => {
  ...
  <div class="min-w-0 flex-1">
    <div
      class="truncate text-2xl font-family font-bold color-text-base cursor-pointer"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WishlistItem, { className: "WishlistItem", filePath: "apps/marketplace-web/src/app/features/wishlist/ui/wishlist-item-ui/wishlist-item.ts", lineNumber: 14 });
})();
...
//# sourceMappingURL=chunk-AZJHEEWL.js.map
