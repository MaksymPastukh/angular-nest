...
var PERSONAL_ROUTES = [
  {
    ...
    children: [
      ...
      {
        path: "info",
        loadComponent: () => import("./chunk-5VBBUGF3.js").then((c) => c.InfoPage),
        data: { breadcrumb: "Personal info" }
      },
      {
        path: "order",
        loadComponent: () => import("./chunk-BVOZEDRY.js").then((c) => c.Order),
        data: { breadcrumb: "Order" }
      },
      {
        path: "wishlist",
        loadComponent: () => import("./chunk-ZMCLNAH6.js").then((c) => c.Wishlist),
...
//# sourceMappingURL=chunk-NZ4NE2QC.js.map
