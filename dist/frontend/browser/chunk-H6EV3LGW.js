...
// libs/frontend/catalog/util/src/lib/utils/filtersToQueryParams.util.ts
...
// libs/frontend/catalog/util/src/lib/utils/mapToApiFilters.util.ts
...
// libs/frontend/catalog/util/src/lib/utils/parseUrlParams.util.ts
...
// libs/frontend/catalog/util/src/lib/utils/build-facets-params.ts
...
// libs/frontend/catalog/util/src/lib/utils/extract-brand.ts
...
// libs/frontend/catalog/util/src/lib/utils/generateColorHex.ts
var COLOR_MAP = {
  Purple: "#8e44ad",
  Black: "#000000",
  Red: "#e74c3c",
...
// libs/frontend/catalog/util/src/lib/utils/parse-to-selected.ts
...
// libs/frontend/catalog/util/src/lib/utils/to-http-params.util.ts
...
// libs/frontend/catalog/data-access/src/lib/data-access/products.service.ts
...
// libs/frontend/catalog/data-access/src/lib/store/catalog-faceds-preview.store.ts
var initialState = {
  activeKey: null,
  brands: null,
  isLoading: false,
...
// libs/frontend/catalog/data-access/src/lib/store/catalog-filter.store.ts
...
// libs/frontend/catalog/data-access/src/lib/store/catalog-filter.facade.ts
...
// libs/frontend/catalog/data-access/src/lib/store/products.store.ts
var initialState3 = {
  products: [],
  filters: {
    page: 1,
...
// libs/frontend/catalog/data-access/src/lib/store/products.facade.ts
...
// libs/frontend/catalog/feature-catalog-page/src/lib/ui/brands-dropdown/brands-dropdown.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BrandsDropdownComponent, { className: "BrandsDropdownComponent", filePath: "libs/frontend/catalog/feature-catalog-page/src/lib/ui/brands-dropdown/brands-dropdown.ts", lineNumber: 26 });
})();

// libs/frontend/catalog/feature-catalog-page/src/lib/ui/catalog-filter/catalog-filter.ts
...
`, styles: [`/* libs/frontend/catalog/feature-catalog-page/src/lib/ui/catalog-filter/catalog-filter.scss */
:host {
  display: block;
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CatalogFilterComponent, { className: "CatalogFilterComponent", filePath: "libs/frontend/catalog/feature-catalog-page/src/lib/ui/catalog-filter/catalog-filter.ts", lineNumber: 25 });
})();

// libs/frontend/catalog/feature-catalog-page/src/lib/pages/catalog-page/catalog-page.ts
...
function CatalogPage_Conditional_8_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-product-card", 9);
    \u0275\u0275listener("toggleWishlist", function CatalogPage_Conditional_8_For_1_Template_app_product_card_toggleWishlist_0_listener() {
      const product_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.toggleWishlist(product_r2.id));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275property("product", product_r2)("inWishlist", ctx_r2.isInWishlist(product_r2.id));
  }
}
function CatalogPage_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, CatalogPage_Conditional_8_For_1_Template, 1, 2, "app-product-card", 8, _forTrack03);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275repeater(ctx_r2.productFacade.products());
  }
}
var CatalogPage = class _CatalogPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CatalogPage, selectors: [["app-catalog"]], decls: 10, vars: 4, consts: [[1, "container", "mx-auto", "flex", "mb-25"], [1, "ml-10", "mt-10", "flex", "flex-col", "z-1"], [1, "font-bold", "text-2xl", "font-family", "color-active"], [1, "flex", "flex-wrap", "mt-10", "gap-x-5", "gap-y-6"], [1, "w-full", "text-center", "py-8"], [3, "itemsTableBestPrice"], [1, "text-lg", "text-gray-600"], [1, "text-sm", "text-gray-500", "mt-2"], [3, "product", "inWishlist"], [3, "toggleWishlist", "product", "inWishlist"]], template: function CatalogPage_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CatalogPage, { className: "CatalogPage", filePath: "libs/frontend/catalog/feature-catalog-page/src/lib/pages/catalog-page/catalog-page.ts", lineNumber: 19 });
})();

export {
  CatalogPage
};
//# sourceMappingURL=chunk-H6EV3LGW.js.map
