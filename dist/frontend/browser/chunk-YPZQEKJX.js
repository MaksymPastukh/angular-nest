...
// libs/frontend/product/ui/src/lib/product-questions/ui/ask-question-form.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AskQuestionForm, { className: "AskQuestionForm", filePath: "libs/frontend/product/ui/src/lib/product-questions/ui/ask-question-form.ts", lineNumber: 51 });
})();

// libs/frontend/product/ui/src/lib/product-questions/ui/my-question-card.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MyQuestionCardComponent, { className: "MyQuestionCardComponent", filePath: "libs/frontend/product/ui/src/lib/product-questions/ui/my-question-card.ts", lineNumber: 57 });
})();
...
// libs/frontend/product/ui/src/lib/product-questions/ui/questions-list.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QuestionsListComponent, { className: "QuestionsListComponent", filePath: "libs/frontend/product/ui/src/lib/product-questions/ui/questions-list.ts", lineNumber: 64 });
})();

// libs/frontend/product/ui/src/lib/reviews/ui/reviews-form/review-form.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReviewFormComponent, { className: "ReviewFormComponent", filePath: "libs/frontend/product/ui/src/lib/reviews/ui/reviews-form/review-form.ts", lineNumber: 25 });
})();

// libs/frontend/product/feature-product-detail/src/lib/ui/product-questions-section.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductQuestionsSectionComponent, { className: "ProductQuestionsSectionComponent", filePath: "libs/frontend/product/feature-product-detail/src/lib/ui/product-questions-section.ts", lineNumber: 37 });
})();

// libs/frontend/product/feature-product-detail/src/lib/ui/reviews/reviews.ts
var _c02 = ["reviewsTop"];
var _c12 = () => [10, 20, 50];
...
function Reviews_Conditional_4_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("first", (ctx_r0.facade.page() - 1) * ctx_r0.facade.pageSize())("rows", ctx_r0.facade.pageSize())("totalRecords", ctx_r0.facade.total())("rowsPerPageOptions", \u0275\u0275pureFunction0(4, _c12));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Reviews, { className: "Reviews", filePath: "libs/frontend/product/feature-product-detail/src/lib/ui/reviews/reviews.ts", lineNumber: 40 });
})();

// libs/frontend/product/feature-product-detail/src/lib/pages/product-detail-page/product-detail-page.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProductDetailPage, { className: "ProductDetailPage", filePath: "libs/frontend/product/feature-product-detail/src/lib/pages/product-detail-page/product-detail-page.ts", lineNumber: 44 });
})();

export {
  ProductDetailPage
};
//# sourceMappingURL=chunk-YPZQEKJX.js.map
