...
// libs/frontend/auth/feature-login/src/lib/pages/login-page/login-page.ts
...
var LoginPage = class _LoginPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginPage, selectors: [["app-login"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 51, vars: 17, consts: () => {
    let i18n_0;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_LOGIN_PAGE_LOGIN_PAGE_TS_0 = goog.getMsg("image login");
      i18n_0 = MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_LOGIN_PAGE_LOGIN_PAGE_TS_0;
    } else {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginPage, { className: "LoginPage", filePath: "libs/frontend/auth/feature-login/src/lib/pages/login-page/login-page.ts", lineNumber: 17 });
})();

// libs/frontend/auth/feature-login/src/lib/pages/request-reset-password/request-reset-password.ts
var _c02 = () => ["/#"];
var _c1 = () => ["/auth/login"];
var RequestResetPassword = class _RequestResetPassword {
  static \u0275fac = function RequestResetPassword_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RequestResetPassword)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RequestResetPassword, selectors: [["app-request-reset-password"]], decls: 20, vars: 5, consts: () => {
    let i18n_0;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_REQUEST_RESET_PASSWORD_REQUEST_RESET_PASSWORD_TS_0 = goog.getMsg("image CheckEmail");
      i18n_0 = MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_REQUEST_RESET_PASSWORD_REQUEST_RESET_PASSWORD_TS_0;
    } else {
      i18n_0 = $localize`:@@imageLogin:image CheckEmail`;
    }
    return [[1, "sm:w-1/2", "w-full"], ["alt", i18n_0, "priority", "", "width", "695", "height", "956", 1, "w-full", "sm:h-full", "object-cover", 3, "ngSrc"], [1, "sm:w-1/2", "w-full", "flex", "flex-col", "items-center", "px-4"], [1, "sm:pt-[90px]", "mb-10", "sm:mb-[120px]", "w-xl", "max-w-full"], [1, "font-semibold", "font-coresans", "text-3xl", "sm:text-4xl", "text-left"], [1, "color-text-base", "mt-[30px]", "font-family", "text-base", "sm:text-sm", "text-left"], [1, "font-bold", "text-[#8a33fd]", "cursor-pointer", 3, "routerLink"], [1, "flex", "items-center", "text-base", "font-family", "text-left", "mt-[30px]", "color-text-base"], ["width", "5", "height", "9", "viewBox", "0 0 5 9", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["d", "M3.58325 1.25L0.716268 4.11698C0.504734 4.32852 0.504734 4.67148 0.716268 4.88302L3.58325 7.75", "stroke", "#3C4242", "stroke-width", "0.975", "stroke-linecap", "round"], [1, "ml-2"], [1, "underline", "cursor-pointer", 3, "routerLink"]];
  }, template: function RequestResetPassword_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275element(1, "img", 1);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(2, "div", 2)(3, "div", 3)(4, "h1", 4);
      \u0275\u0275text(5, "Check Email");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "h3", 5);
      \u0275\u0275text(7, " Please check your email inbox and click on the provided link to reset your password. ");
      \u0275\u0275element(8, "br");
      \u0275\u0275text(9, " If you don\u2019t receive email, ");
      \u0275\u0275elementStart(10, "a", 6);
      \u0275\u0275text(11, "Click here to resend ");
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275property("ngSrc", "/assets/images/check-email-page.png");
      \u0275\u0275advance(9);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(3, _c02));
      \u0275\u0275advance(8);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(4, _c1));
    }
  }, dependencies: [CommonModule, RouterLink, NgOptimizedImage], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RequestResetPassword, [{
    type: Component,
    args: [{ selector: "app-request-reset-password", imports: [CommonModule, RouterLink, NgOptimizedImage], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="sm:w-1/2 w-full">
  <img
    class="w-full sm:h-full object-cover"
    alt="image CheckEmail"
    priority
    width="695"
    height="956"
    [ngSrc]="'/assets/images/check-email-page.png'"
    i18n-alt="@@imageLogin"
  />
</div>
<div class="sm:w-1/2 w-full flex flex-col items-center px-4">
  <div class="sm:pt-[90px] mb-10 sm:mb-[120px] w-xl max-w-full">
    <h1 class="font-semibold font-coresans text-3xl sm:text-4xl text-left">Check Email</h1>
    <h3 class="color-text-base mt-[30px] font-family text-base sm:text-sm text-left">
      Please check your email inbox and click on the provided link to reset your password. <br />
      If you don\u2019t receive email,
      <a [routerLink]="['/#']" class="font-bold text-[#8a33fd] cursor-pointer"
        >Click here to resend
      </a>
    </h3>
    <div class="flex items-center text-base font-family text-left mt-[30px] color-text-base">
      <svg width="5" height="9" viewBox="0 0 5 9" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M3.58325 1.25L0.716268 4.11698C0.504734 4.32852 0.504734 4.67148 0.716268 4.88302L3.58325 7.75"
          stroke="#3C4242"
          stroke-width="0.975"
          stroke-linecap="round"
        />
      </svg>
      <span class="ml-2">Back to </span>&nbsp;<a
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RequestResetPassword, { className: "RequestResetPassword", filePath: "libs/frontend/auth/feature-login/src/lib/pages/request-reset-password/request-reset-password.ts", lineNumber: 12 });
})();

// libs/frontend/auth/feature-login/src/lib/pages/reset/reset.ts
var _c03 = () => ["/auth/login"];
function ResetComponent_Conditional_1_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 11);
    \u0275\u0275element(1, "path", 19)(2, "path", 20);
    \u0275\u0275elementEnd();
  }
}
function ResetComponent_Conditional_1_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function ResetComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, " Create New Password ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "h3", 6);
    \u0275\u0275text(7, " Your new password must be different from previous used passwords. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 7)(9, "div", 8)(10, "label", 9);
    \u0275\u0275text(11, "Password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "button", 10);
    \u0275\u0275listener("click", function ResetComponent_Conditional_1_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePasswordVisibility());
    });
    \u0275\u0275conditionalCreate(13, ResetComponent_Conditional_1_Conditional_13_Template, 3, 0, ":svg:svg", 11)(14, ResetComponent_Conditional_1_Conditional_14_Template, 2, 0, ":svg:svg", 12);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(15, "input", 13);
    \u0275\u0275elementStart(16, "div", 14);
    \u0275\u0275text(17, " Use 8 or more characters with a mix of letters, numbers & symbols ");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngSrc", "/assets/images/create-new-password-page.png");
    \u0275\u0275advance(12);
    \u0275\u0275conditional(!ctx_r1.isPasswordVisible ? 13 : 14);
    \u0275\u0275advance(2);
    \u0275\u0275property("type", \u0275\u0275interpolate(ctx_r1.isPasswordVisible ? "text" : "password"));
    \u0275\u0275advance(6);
    \u0275\u0275property("type", \u0275\u0275interpolate(ctx_r1.isPasswordVisible ? "text" : "password"));
  }
}
function ResetComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 1);
    \u0275\u0275element(1, "img", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 3)(3, "div", 23)(4, "h1", 5);
    \u0275\u0275text(5, " Reset Your Password ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "h3", 24);
    \u0275\u0275text(7, " Enter your email and we'll send you a link to reset your password.");
    \u0275\u0275element(8, "br");
    \u0275\u0275text(9, "Please check it. ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(21, "\xA0");
    \u0275\u0275elementStart(22, "a", 33);
    \u0275\u0275text(23, " Login");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275property("ngSrc", "/assets/images/resed-password-page.png");
    \u0275\u0275advance(21);
...
var ResetComponent = class _ResetComponent {
  ...
  static \u0275fac = function ResetComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ResetComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResetComponent, selectors: [["app-reset"]], decls: 3, vars: 1, consts: () => {
    let i18n_0;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_RESET_RESET_TS_0 = goog.getMsg("image login");
      i18n_0 = MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_RESET_RESET_TS_0;
    } else {
      i18n_0 = $localize`:@@imageLogin:image login`;
    }
    let i18n_1;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_RESET_RESET_TS_1 = goog.getMsg("image login");
      i18n_1 = MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_RESET_RESET_TS_1;
    } else {
      i18n_1 = $localize`:@@imageLogin:image login`;
    }
    return [[1, "flex", "flex-col", "sm:flex-row", "min-h-screen", "overflow-hidden"], [1, "sm:w-1/2", "w-full"], ["alt", i18n_0, "priority", "", "width", "695", "height", "956", 1, "w-full", "sm:h-full", "object-cover", 3, "ngSrc"], [1, "sm:w-1/2", "w-full", "flex", "flex-col", "items-center", "px-4"], [1, "sm:pt-[90px]", "mb-10", "sm:mb-[120px]", "max-w-full"], [1, "font-semibold", "font-coresans", "text-3xl", "sm:text-4xl", "text-left"], [1, "text-gray-600/80", "mt-[10px]", "font-family", "text-base", "sm:text-sm", "text-left"], [1, "flex", "flex-col", "mt-[30px]", "gap-2", "color-text-base"], [1, "flex", "create-new-pass", "justify-between"], ["for", "password", 1, "font-normal", "font-family", "text-lg"], ["type", "button", 1, "cursor-pointer", "flex", "items-center", 3, "click"], ["width", "19", "height", "16", "viewBox", "0 0 19 16", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["width", "18", "height", "13", "viewBox", "0 0 18 13", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["pInputText", "", "type", "password", "id", "password", "aria-describedby", "password-help", 1, "auth-input", 3, "type"], [1, "font-family", "text-base", "color-text-base"], [1, "mb-[30px]", "mt-[30px]", "flex", "flex-col", "gap-2", "color-text-base"], ["for", "confirm-password", 1, "font-normal", "font-family", "text-lg"], ["pInputText", "", "type", "password", "id", "confirm-password", "aria-describedby", "confirm-password-help", 1, "auth-input", 3, "type"], ["type", "button", 1, "w-[167px]", "mt-[40px]", "bg-purple-600", "text-white", "text-lg", "p-3", "rounded-lg", "cursor-pointer"], ["d", "M16.9682 0.869862L16.2322 0.133919C16.0242 -0.0740721 15.6402 -0.042063 15.4002 0.245882L12.84 2.78985C11.688 2.29391 10.4241 2.05391 9.09604 2.05391C5.14392 2.06984 1.72014 4.37381 0.0720207 7.68602C-0.0240069 7.89401 -0.0240069 8.14994 0.0720207 8.32593C0.839954 9.89395 1.99202 11.19 3.43203 12.1659L1.33603 14.2939C1.09603 14.5339 1.06402 14.9179 1.22407 15.1259L1.96002 15.8618C2.16801 16.0698 2.55199 16.0378 2.79199 15.7499L16.8399 1.70198C17.1439 1.46211 17.1759 1.07815 16.9679 0.870136L16.9682 0.869862ZM9.94403 5.70175C9.67202 5.63773 9.38407 5.55778 9.11205 5.55778C7.752 5.55778 6.66411 6.6458 6.66411 8.00571C6.66411 8.27772 6.72813 8.56566 6.80809 8.83768L5.73597 9.89372C5.41601 9.33376 5.24003 8.70966 5.24003 8.00574C5.24003 5.87776 6.95205 4.16574 9.08003 4.16574C9.78409 4.16574 10.4081 4.34172 10.968 4.66168L9.94403 5.70175Z", "fill", "#807D7E"], ["d", "M18.1206 7.68596C17.5606 6.56591 16.8246 5.55798 15.9127 4.74194L12.9366 7.68596V8.00591C12.9366 10.1339 11.2246 11.8459 9.09661 11.8459H8.77665L6.88867 13.7339C7.59273 13.8779 8.32868 13.9739 9.04868 13.9739C13.0008 13.9739 16.4246 11.6699 18.0727 8.34177C18.2167 8.11771 18.2167 7.8938 18.1206 7.68578L18.1206 7.68596Z", "fill", "#807D7E"], ["d", "M9 0C5.04856 0 1.65436 2.37401 0.151954 5.77272C0.0495662 6.00434 0.0495663 6.26839 0.151954 6.50001C1.65436 9.89872 5.04856 12.2727 9 12.2727C12.9514 12.2727 16.3456 9.89872 17.848 6.50001C17.9504 6.26839 17.9504 6.00434 17.848 5.77272C16.3456 2.37401 12.9514 0 9 0ZM9 10.2273C6.74182 10.2273 4.90909 8.39455 4.90909 6.13636C4.90909 3.87818 6.74182 2.04545 9 2.04545C11.2582 2.04545 13.0909 3.87818 13.0909 6.13636C13.0909 8.39455 11.2582 10.2273 9 10.2273ZM9 3.68182C7.64182 3.68182 6.54545 4.77818 6.54545 6.13636C6.54545 7.49455 7.64182 8.59091 9 8.59091C10.3582 8.59091 11.4545 7.49455 11.4545 6.13636C11.4545 4.77818 10.3582 3.68182 9 3.68182Z", "fill", "#807D7E"], ["alt", i18n_1, "priority", "", "width", "695", "height", "956", 1, "w-full", "sm:h-full", "object-cover", 3, "ngSrc"], [1, "sm:pt-[90px]", "mb-10", "sm:mb-[120px]", "w-xl", "max-w-full"], [1, "color-text-base", "mt-[30px]", "font-family", "text-base", "sm:text-sm", "text-left"], [1, "mb-[30px]", "mt-[50px]", "flex", "flex-col", "gap-2", "color-text-base"], ["for", "username", 1, "font-normal", "font-family", "text-lg"], ["pInputText", "", "id", "username", "placeholder", "designer@gmail.com", "aria-describedby", "username-help", 1, "auth-input"], ["type", "button", 1, "w-[167px]", "bg-purple-600", "text-white", "text-lg", "p-3", "rounded-lg", "mt-[50px]", "cursor-pointer"], [1, "flex", "items-center", "text-base", "font-family", "text-left", "mt-[30px]", "color-text-base"], ["width", "5", "height", "9", "viewBox", "0 0 5 9", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["d", "M3.58325 1.25L0.716268 4.11698C0.504734 4.32852 0.504734 4.67148 0.716268 4.88302L3.58325 7.75", "stroke", "#3C4242", "stroke-width", "0.975", "stroke-linecap", "round"], [1, "ml-2"], [1, "underline", "cursor-pointer", 3, "routerLink"]];
  }, template: function ResetComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 0);
      \u0275\u0275conditionalCreate(1, ResetComponent_Conditional_1_Template, 24, 6)(2, ResetComponent_Conditional_2_Template, 24, 3);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isCreateNewPassword ? 1 : ctx.isResetPassword ? 2 : -1);
    }
  }, dependencies: [CommonModule, NgOptimizedImage, RouterLink], styles: ["\n\n.create-new-pass[_ngcontent-%COMP%] {\n  position: relative;\n}\n.create-new-pass[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 58px;\n  right: 15px;\n}\n/*# sourceMappingURL=reset.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ResetComponent, [{
    type: Component,
    args: [{ selector: "app-reset", imports: [CommonModule, NgOptimizedImage, RouterLink], changeDetection: ChangeDetectionStrategy.OnPush, template: `<section class="flex flex-col sm:flex-row min-h-screen overflow-hidden">
  @if (isCreateNewPassword) {
    <div class="sm:w-1/2 w-full">
      <img
        ...
        width="695"
        height="956"
        [ngSrc]="'/assets/images/create-new-password-page.png'"
        i18n-alt="@@imageLogin"
      />
    </div>
    <div class="sm:w-1/2 w-full flex flex-col items-center px-4">
      <div class="sm:pt-[90px] mb-10 sm:mb-[120px] max-w-full">
        <h1 class="font-semibold font-coresans text-3xl sm:text-4xl text-left">
          Create New Password
        </h1>
        <h3 class="text-gray-600/80 mt-[10px] font-family text-base sm:text-sm text-left">
          Your new password must be different from previous used passwords.
        </h3>
        <div class="flex flex-col mt-[30px] gap-2 color-text-base">
          <div class="flex create-new-pass justify-between">
            <label class="font-normal font-family text-lg" for="password">Password</label>
            <button
              type="button"
              class="cursor-pointer flex items-center"
          ...
          <input
            ...
            aria-describedby="password-help"
          />
          <div class="font-family text-base color-text-base">
            Use 8 or more characters with a mix of letters, numbers & symbols
          </div>
        </div>
        <div class="mb-[30px] mt-[30px] flex flex-col gap-2 color-text-base">
          <label class="font-normal font-family text-lg" for="confirm-password"
        ...
        <button
          type="button"
          class="w-[167px] mt-[40px] bg-purple-600 text-white text-lg p-3 rounded-lg cursor-pointer"
        >
          Reset Password
        </button>
      </div>
    ...
    <div class="sm:w-1/2 w-full">
      <img
        ...
        width="695"
        height="956"
        [ngSrc]="'/assets/images/resed-password-page.png'"
        i18n-alt="@@imageLogin"
      />
    </div>
    <div class="sm:w-1/2 w-full flex flex-col items-center px-4">
      <div class="sm:pt-[90px] mb-10 sm:mb-[120px] w-xl max-w-full">
        ...
        <div class="mb-[30px] mt-[50px] flex flex-col gap-2 color-text-base">
          <label class="font-normal font-family text-lg" for="username">Email Address</label>
          <input
            pInputText
            id="username"
        ...
        <button
          type="button"
          class="w-[167px] bg-purple-600 text-white text-lg p-3 rounded-lg mt-[50px] cursor-pointer"
        >
          Send
        </button>
        <div class="flex items-center text-base font-family text-left mt-[30px] color-text-base">
...
`, styles: ["/* libs/frontend/auth/feature-login/src/lib/pages/reset/reset.scss */\n.create-new-pass {\n  position: relative;\n}\n.create-new-pass button {\n  position: absolute;\n  top: 58px;\n  right: 15px;\n}\n/*# sourceMappingURL=reset.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResetComponent, { className: "ResetComponent", filePath: "libs/frontend/auth/feature-login/src/lib/pages/reset/reset.ts", lineNumber: 12 });
})();

// libs/frontend/auth/feature-login/src/lib/pages/verification/verification.ts
var Verification = class _Verification {
  static \u0275fac = function Verification_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Verification)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Verification, selectors: [["app-verification"]], decls: 15, vars: 1, consts: () => {
    let i18n_0;
    if (false) {
      const MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_VERIFICATION_VERIFICATION_TS_0 = goog.getMsg("image Verification");
      i18n_0 = MSG_EXTERNAL_imageLogin$$LIBS_FRONTEND_AUTH_FEATURE_LOGIN_SRC_LIB_PAGES_VERIFICATION_VERIFICATION_TS_0;
    } else {
      i18n_0 = $localize`:@@imageLogin:image Verification`;
    }
    return [[1, "flex", "flex-col", "sm:flex-row", "min-h-screen", "overflow-hidden"], [1, "sm:w-1/2", "w-full"], ["alt", i18n_0, "priority", "", "width", "695", "height", "695", 1, "w-full", "sm:h-full", "object-cover", 3, "ngSrc"], [1, "sm:w-1/2", "w-full", "flex", "flex-col", "items-center", "px-4"], [1, "sm:pt-[90px]", "mb-10", "sm:mb-[120px]", "w-xl", "max-w-full"], [1, "font-semibold", "font-coresans", "text-3xl", "sm:text-4xl", "text-left"], [1, "color-text-base", "mt-[10px]", "font-family", "text-base", "sm:text-sm", "text-left"], [1, "mb-[30px]", "mt-[30px]", "flex", "flex-col", "gap-2", "color-text-base"], ["for", "verification", 1, "font-normal", "font-family", "text-lg"], ["pInputText", "", "type", "number", "id", "verification", "aria-describedby", "verification-help", 1, "auth-input"], ["type", "button", 1, "w-[167px]", "bg-purple-600", "text-white", "text-lg", "p-3", "rounded-lg", "mt-[30px]", "cursor-pointer"]];
  }, template: function Verification_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, " The code was sent to your Email, enter it to confirm your account. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "div", 7)(10, "label", 8);
      \u0275\u0275text(11, "Verification Code");
      \u0275\u0275elementEnd();
      \u0275\u0275element(12, "input", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "button", 10);
      \u0275\u0275text(14, " Verify Code ");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("ngSrc", "/assets/images/verification-page.png");
    }
  }, dependencies: [CommonModule, NgOptimizedImage], encapsulation: 2, changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Verification, [{
    type: Component,
    args: [{ selector: "app-verification", imports: [CommonModule, NgOptimizedImage], changeDetection: ChangeDetectionStrategy.OnPush, template: `<section class="flex flex-col sm:flex-row min-h-screen overflow-hidden">
  <div class="sm:w-1/2 w-full">
    <img
      class="w-full sm:h-full object-cover"
      ...
      width="695"
      height="695"
      [ngSrc]="'/assets/images/verification-page.png'"
      i18n-alt="@@imageLogin"
    />
  </div>
  <div class="sm:w-1/2 w-full flex flex-col items-center px-4">
    <div class="sm:pt-[90px] mb-10 sm:mb-[120px] w-xl max-w-full">
      <h1 class="font-semibold font-coresans text-3xl sm:text-4xl text-left">Verification</h1>
      <h3 class="color-text-base mt-[10px] font-family text-base sm:text-sm text-left">
        The code was sent to your Email, enter it to confirm your account.
      </h3>
      <div class="mb-[30px] mt-[30px] flex flex-col gap-2 color-text-base">
        <label class="font-normal font-family text-lg" for="verification">Verification Code</label>
        <input
          pInputText
          type="number"
          id="verification"
      ...
      <button
        type="button"
        class="w-[167px] bg-purple-600 text-white text-lg p-3 rounded-lg mt-[30px] cursor-pointer"
      >
        Verify Code
      </button>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Verification, { className: "Verification", filePath: "libs/frontend/auth/feature-login/src/lib/pages/verification/verification.ts", lineNumber: 11 });
})();
export {
  LoginPage,
...
//# sourceMappingURL=chunk-C6W7KYR4.js.map
