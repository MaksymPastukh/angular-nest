...
// apps/marketplace-web/src/app/features/wishlist/domain/constants/wishlist-item-sourse.constants.ts
...
// apps/marketplace-web/src/app/features/wishlist/data-access/wishlist.service.ts
var WishlistService = class _WishlistService {
  http = inject(HttpClient);
  baseUrl = `${environment.api}wishlist`;
  getWishlist(params = {}) {
...
// apps/marketplace-web/src/app/features/wishlist/store/wishlist.store.ts
var initialState = {
  items: [],
  nextCursor: null,
  hasMore: false,
...
// apps/marketplace-web/src/app/features/wishlist/store/wishlist.facade.ts
...
//# sourceMappingURL=chunk-EWMRC4OU.js.map
