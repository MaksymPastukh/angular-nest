import {
  InfoPage
} from "./chunk-AWDTWSKO.js";
import {
  Order
} from "./chunk-TEB7IB3Y.js";
import {
  Wishlist
} from "./chunk-NWHLVXXF.js";
import {
  AuthCoreFacade,
  AuthState
...
// libs/frontend/personal/feature-account/src/lib/ui/account-nav/account-nav.ts
var _c0 = () => ({ exact: true });
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AccountNav, selectors: [["app-account-nav"]], decls: 23, vars: 3, consts: [[1, "rounded-2xl", "bg-white", "p-4"], [1, "mb-6"], [1, "flex", "items-start", "gap-3"], [1, "mt-1", "h-6", "w-1", "rounded-full", "bg-(--color-primary)"], [1, "font-coresans", "text-2xl", "font-semibold", "text-(--color-text-base)"], [1, "mt-1", "text-sm", "text-(--color-text-gray)"], [1, "[&>a]:flex", "[&>a]:cursor-pointer", "[&>a]:items-center", "[&>a]:gap-3", "[&>a]:rounded-xl", "[&>a]:px-3", "[&>a]:py-2.5", "[&>a]:text-sm", "[&>a]:text-[var(--color-text-menu-gray)]", "[&>a:hover]:bg-gray-50", "[&>a:hover]:text-[var(--color-text-base)]", "[&>a]:transition-colors", "[&_i]:text-base", "[&>a.active]:bg-gray-50", "[&>a.active]:text-[var(--color-text-base)]", "[&>a.active]:relative", "[&>a.active]:pl-4", "[&>a.active]:before:content-['']", "[&>a.active]:before:absolute", "[&>a.active]:before:left-0", "[&>a.active]:before:top-2.5", "[&>a.active]:before:bottom-2.5", "[&>a.active]:before:w-0.5", "[&>a.active]:before:rounded-full", "[&>a.active]:before:bg-[var(--color-text-base)]"], ["routerLink", "/admin/panel", "routerLinkActive", "active", 3, "routerLinkActiveOptions"], ["routerLink", "/account/order", "routerLinkActive", "active"], [1, "pi", "pi-shopping-bag"], ["routerLink", "/account/wishlist", "routerLinkActive", "active"], [1, "pi", "pi-heart"], ["routerLink", "/account/info", "routerLinkActive", "active", 3, "routerLinkActiveOptions"], [1, "pi", "pi-user"], ["role", "button", "tabindex", "0", 3, "click", "keydown.enter", "keydown.space"], [1, "pi", "pi-sign-out"]], template: function AccountNav_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AccountNav_Template_a_click_20_listener() {
        return ctx.onLogout();
      })("keydown.enter", function AccountNav_Template_a_keydown_enter_20_listener() {
        return ctx.onLogout();
      })("keydown.space", function AccountNav_Template_a_keydown_space_20_listener($event) {
        ctx.onLogout();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AccountNav, { className: "AccountNav", filePath: "libs/frontend/personal/feature-account/src/lib/ui/account-nav/account-nav.ts", lineNumber: 13 });
})();

// libs/frontend/personal/feature-account/src/lib/ui/account-layout/account-layout.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AccountLayout, { className: "AccountLayout", filePath: "libs/frontend/personal/feature-account/src/lib/ui/account-layout/account-layout.ts", lineNumber: 15 });
})();

// libs/frontend/personal/feature-account/src/lib/personal.routes.ts
var PERSONAL_ROUTES = [
  {
    path: "account",
    ...
    children: [
      ...
      {
        path: "info",
        loadComponent: () => import("./chunk-UYUMLTNN.js").then((c) => c.InfoPage),
        data: { breadcrumb: "Personal info" }
      },
      {
        path: "order",
        loadComponent: () => import("./chunk-M34NXHUX.js").then((c) => c.Order),
        data: { breadcrumb: "Order" }
      },
      {
        path: "wishlist",
        loadComponent: () => import("./chunk-JVNLTN2L.js").then((c) => c.Wishlist),
...
//# sourceMappingURL=chunk-RB2XEARS.js.map
