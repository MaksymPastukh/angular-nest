...
var DomHandler = class _DomHandler {
  ...
  static getOuterWidth(el, margin) {
    ...
    if (margin) {
      let style15 = getComputedStyle(el);
      width += parseFloat(style15.marginLeft) + parseFloat(style15.marginRight);
    }
    return width;
  }
  static getHorizontalPadding(el) {
    let style15 = getComputedStyle(el);
    return parseFloat(style15.paddingLeft) + parseFloat(style15.paddingRight);
  }
  static getHorizontalMargin(el) {
    let style15 = getComputedStyle(el);
    return parseFloat(style15.marginLeft) + parseFloat(style15.marginRight);
  }
  static innerWidth(el) {
    let width = el.offsetWidth;
    let style15 = getComputedStyle(el);
    width += parseFloat(style15.paddingLeft) + parseFloat(style15.paddingRight);
    return width;
  }
  static width(el) {
    let width = el.offsetWidth;
  ...
  static getInnerHeight(el) {
    ...
    let style15 = getComputedStyle(el);
    height += parseFloat(style15.paddingTop) + parseFloat(style15.paddingBottom);
    return height;
  }
  static getOuterHeight(el, margin) {
    ...
    if (margin) {
      let style15 = getComputedStyle(el);
      height += parseFloat(style15.marginTop) + parseFloat(style15.marginBottom);
    }
    return height;
  }
  static getHeight(el) {
    let height = el.offsetHeight;
    let style15 = getComputedStyle(el);
    height -= parseFloat(style15.paddingTop) + parseFloat(style15.paddingBottom) + parseFloat(style15.borderTopWidth) + parseFloat(style15.borderBottomWidth);
    return height;
  }
  static getWidth(el) {
    let width = el.offsetWidth;
    let style15 = getComputedStyle(el);
    width -= parseFloat(style15.paddingLeft) + parseFloat(style15.paddingRight) + parseFloat(style15.borderLeftWidth) + parseFloat(style15.borderRightWidth);
    return width;
  }
  static getViewport() {
  ...
  static calculateScrollbarWidth(el) {
    if (el) {
      let style15 = getComputedStyle(el);
      return el.offsetWidth - el.clientWidth - parseFloat(style15.borderLeftWidth) - parseFloat(style15.borderRightWidth);
    } else {
...
var Scroller = class _Scroller extends BaseComponent {
  ...
  getContentPosition() {
    if (this.contentEl) {
      const style15 = getComputedStyle(this.contentEl);
      const left = parseFloat(style15.paddingLeft) + Math.max(parseFloat(style15.left) || 0, 0);
      const right = parseFloat(style15.paddingRight) + Math.max(parseFloat(style15.right) || 0, 0);
      const top = parseFloat(style15.paddingTop) + Math.max(parseFloat(style15.top) || 0, 0);
      const bottom = parseFloat(style15.paddingBottom) + Math.max(parseFloat(style15.bottom) || 0, 0);
      return {
        left,
        right,
        top,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c017, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.contentTemplate = _t.first);
...
function Select_ng_template_9_p_scroller_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(9, _c018, ctx_r2.scrollHeight));
...
function Select_ng_template_9_ng_template_8_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(8, _c018, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("optionGroup"));
...
function Select_ng_template_9_ng_template_8_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(5, _c018, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("emptyMessage"));
    \u0275\u0275advance();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function SelectItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("id", ctx.id)("pBind", ctx.getPTOptions())("ngStyle", \u0275\u0275pureFunction1(17, _c018, (ctx.scrollerOptions == null ? null : ctx.scrollerOptions.itemSize) + "px"));
...
var InputNumber = class _InputNumber extends BaseInput {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function InputNumber_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c019, 4)(dirIndex, _c110, 4)(dirIndex, _c29, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.clearIconTemplate = _t.first);
...
var Paginator = class _Paginator extends BaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Paginator_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c020, 4)(dirIndex, _c111, 4)(dirIndex, _c210, 4)(dirIndex, _c35, 4)(dirIndex, _c44, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.dropdownIconTemplate = _t.first);
...
//# sourceMappingURL=chunk-LJIN2HB3.js.map
