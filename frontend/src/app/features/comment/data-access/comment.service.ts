...
import { CommentCreateInterface } from '../domain/interface/comment-create.interface'
import { CommentInterface } from '../domain/interface/comment.interface'
import { CommentsPaginatedResponseInterface } from '../domain/interface/comments-paginated-response.interface'

type CommentsPaginatedResponse = CommentsPaginatedResponseInterface
