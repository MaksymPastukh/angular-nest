...
import { CommentStateInterface } from '../domain/interface/comment-state.interface'
import { CommentEntity, CommentInterface } from '../domain/interface/comment.interface'
import {
  mapAndSortComments,
  mapCommentToEntity,
  mergeComments,
...
export type CommentStoreType = InstanceType<typeof CommentStore>
